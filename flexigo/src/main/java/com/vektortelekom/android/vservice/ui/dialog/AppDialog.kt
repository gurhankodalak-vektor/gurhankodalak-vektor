...
class AppDialog(private var param: AppDialogParam) : Dialog(param.context) {
    ...
    class Builder constructor(val context: Context) {
        ...
        inline fun setOkButton(@StringRes textId: Int, crossinline listener: (AppDialog) -> Unit): Builder {
            return setOkButton(param.context.getText(textId).toString(), listener)
        }

        inline fun setOkButton(buttonName: String, crossinline listener: (AppDialog) -> Unit): Builder {
            param.okButtonText = buttonName
            param.mOkButtonListener = object : OnClickListener {
                override fun onClick(dialog: AppDialog) {
                    listener(dialog)
                }
            }
            return this
        ...
        inline fun setCancelButton(@StringRes textId: Int, crossinline listener: (AppDialog) -> Unit): Builder {
            return setCancelButton(param.context.getText(textId).toString(), listener)
        }

        inline fun setCancelButton(buttonName: String, crossinline listener: (AppDialog) -> Unit): Builder {
        ...
        inline fun setOtherButton(@StringRes textId: Int, crossinline listener: (AppDialog) -> Unit): Builder {
            return setOtherButton(param.context.getText(textId).toString(), listener)
        }

        inline fun setOtherButton(buttonName: String, crossinline listener: (AppDialog) -> Unit): Builder {
        ...
        fun create(): AppDialog {
            return AppDialog(param)
        }

    }

    interface OnClickListener {
        fun onClick(dialog: AppDialog)
    }
