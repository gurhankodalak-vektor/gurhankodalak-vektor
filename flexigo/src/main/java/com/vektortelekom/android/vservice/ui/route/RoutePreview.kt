...
class RoutePreview : BaseFragment<RouteSearchViewModel>(), PermissionsUtils.LocationStateListener {
    @Inject
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = DataBindingUtil.inflate<BottomSheetRoutePreviewBinding>(inflater, R.layout.bottom_sheet_route_preview, container, false).apply {
            lifecycleOwner = this@RoutePreview
        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        routePreviewAdapter = RoutePreviewAdapter(object: RoutePreviewAdapter.RoutePreviewListener {
            override fun seeStopsClick(route: RouteModel) {
                NavHostFragment.findNavController(this@RoutePreview).navigate(R.id.action_routePreview_to_routeSearchReservation)
            }
        ...
        routePreviewAdapter?.setPageName("RoutePreview")
    ...
    companion object {
        const val TAG: String = "RoutePreview"

        fun newInstance() = RoutePreview()
