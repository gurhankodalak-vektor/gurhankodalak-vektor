package com.vektortelekom.android.vservice.ui.vanpool
...
class VanPoolDriverActivity : BaseActivity<HomeViewModel>(), PermissionsUtils.LocationStateListener {
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView<VanpoolDriverActivityBinding>(this, R.layout.vanpool_driver_activity).apply {
            lifecycleOwner = this@VanPoolDriverActivity
        }

        if ((this@VanPoolDriverActivity as BaseActivity<*>).checkAndRequestLocationPermission(this)) {
    ...
    companion object {
        ...
        fun newInstance() = VanPoolDriverActivity()
    ...
    override fun onLocationPermissionOk() {
        ...
        locationClient.start(20 * 1000, object : FusedLocationClient.FusedLocationCallback {
            ...
            override fun onLocationFailed(message: String) {
                ...
                if(this@VanPoolDriverActivity.isFinishing || this@VanPoolDriverActivity.isDestroyed) {
                    return
                }
